...
func (app *Application) AddToCart() gin.HandlerFunc { // (app *Application) is receiver of the function
	return func(c *gin.Context) {
		...
		productID, err := primitive.ObjectIDFromHex(productQueryID) // This function takes a hexadecimal string (productQueryID) and converts it into a primitive.ObjectID.
		if err != nil {
			log.Println(err)
